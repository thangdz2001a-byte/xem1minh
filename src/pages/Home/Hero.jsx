...
import { API, getImg, safeText, isHoatHinhMovie, mergeDuplicateMovies, getMovieUniqueId, globalDisplayedSlugs, fetchWithCache } from "../../utils/helpers";
...
export default function Hero({ navigate }) {
  ...
  useEffect(() => {
    const fetchBannerData = async () => {
      try {
        // --- SỬ DỤNG FETCH CACHE SIÊU TỐC ---
        const res1 = await fetchWithCache(`${API}/danh-sach/phim-moi-cap-nhat?page=1`);
        const res2 = await fetchWithCache(`${API}/danh-sach/phim-moi-cap-nhat?page=2`);
        const res3 = await fetchWithCache(`${API}/danh-sach/phim-moi-cap-nhat?page=3`);
